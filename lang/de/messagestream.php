...
$string['promptrefinement'] = 'Prompt-Verfeinerung (für KI verwendet). Z. B.: "Gib deine Einschätzung zum Post eines Users ab."';
...
$string['coachsettings:tab'] = 'Coach-Einstellungen';
...
$string['coachsettings:save'] = 'Coach-Einstellungen speichern';
$string['coachsettings:saved'] = 'Coach-Einstellungen gespeichert.';
...
$string['coachsettings:section_heading_style'] = 'A — Stil';
$string['coachsettings:section_heading_feedback'] = 'B — Feedback';
$string['coachsettings:section_heading_knowledge'] = 'C — Wissen';
$string['coachsettings:section_heading_interaction'] = 'D — Interaktion';
